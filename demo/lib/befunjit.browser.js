...
(function() {
  'use strict';
  var BinaryCompiler, assemble, generateCode, generateTree;
  ...
  assemble = function(path, options) {
    ...
    max = bef.PathMetrics.getDepth(path).max;
    codes = (function() {
      var j, ref, results;
      results = [];
...
(function() {
  'use strict';
  var StackingCompiler, assemble, assembleTight, binaryOperator, codeMap, digitPusher, isNumber, makeStack, writeBack;
  ...
  assembleTight = function(path, options) {
    ...
    ref = bef.PathMetrics.getDepth(path), max = ref.max, sum = ref.sum;
